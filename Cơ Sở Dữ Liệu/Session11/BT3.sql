...
-- 4 --
DELIMITER //
CREATE PROCEDURE IncreaseEmployeeSalary(IN EmployeeID INT, INOUT CurrentSalary DECIMAL(10,2))
BEGIN
...
SET @CurrentSalary = (SELECT Salary FROM Employees WHERE EmployeeID = 4);
CALL IncreaseEmployeeSalary(4, @CurrentSalary);
